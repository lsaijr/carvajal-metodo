...
REGLAS: Respetar intolerancias. Tips con nombre, profesion, horario real.'''
    ...
    CATALOGO = (
        ...
        '[Exilis] Precios: EXILIS Abdomen 8ses $1000 | Problemas: Grasa localizada,Flacidez corporal,Contorno corporal,Celulitis | Zonas: Abdomen,Flancos,Brazos,Piernas,Glúteos | Grado: Leve,Moderado | Sesiones: 4 | Intervalo: 10-14 días | Recovery: Sin downtime | Combinar: Presoterapia,X-Wave | NO combinar: Calor profundo intenso mismo día | Orden: Exilis → drenaje (mismo día o posterior) | CONTRAINDICACIONES: Embarazo,Marcapasos,Cáncer activo,Infección activa,Heridas abiertas\n'
